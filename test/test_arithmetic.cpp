...
TEST(ArithmeticTest, PolinomConst){
    ...
    std::map<std::string, Polinom> values = {{"a", Polinom("20")}, {"b", Polinom("40")}, {"c", Polinom("4")}, {"d", Polinom("8")}};
    EXPECT_EQ(expr.Calculate(values), Polinom("60"));
}

TEST(ArithmeticTest, PolinomDefault){
    Arithmetic<Polinom> expr("a + b");
    std::map<std::string, Polinom> values = {{"a", Polinom("20x1y1z1")}, {"b", Polinom("40")}, {"c", Polinom("4")}, {"d", Polinom("8")}};
    EXPECT_EQ(expr.Calculate(values), Polinom("20x1y1z1+40"));
}

TEST(ArithmeticTest, PolinomAssoch){
    Arithmetic<Polinom> expr("a - (b + c)");
    std::map<std::string, Polinom> values = {{"a", Polinom("100x1y1z1")}, {"b", Polinom("40")}, {"c", Polinom("4")}, {"d", Polinom("8")}};
